...
import { insertCharterSchema } from "@shared/schema";
...
export default function EditCharter() {
  ...
  useEffect(() => {
    if (charter && charter.name) {
      ...
      const formValues = {
        ...
        isActive: charter.isActive !== undefined ? charter.isActive : true,
        autoApprove: charter.autoApprove !== undefined ? charter.autoApprove : false,
        allowPosts: charter.allowPosts !== undefined ? charter.allowPosts : true,
      };
      ...
      setTimeout(() => {
        ...
        form.setValue("isActive", charter.isActive !== undefined ? charter.isActive : true);
        form.setValue("autoApprove", charter.autoApprove !== undefined ? charter.autoApprove : false);
        form.setValue("allowPosts", charter.allowPosts !== undefined ? charter.allowPosts : true);
      }, 100);
    }
  }, [charter, form]);

  const updateCharterMutation = useMutation({
    mutationFn: async (data: EditCharterForm) => {
  ...
  const onSubmit = async (data: EditCharterForm) => {
    ...
    try {
      await updateCharterMutation.mutateAsync(finalData);
    } catch (error) {
    ...
    return (
      <div className="min-h-screen gradient-bg flex items-center justify-center">
        <div className="animate-pulse space-y-4">
          ...
          <div className="h-4 bg-black bg-opacity-10 rounded w-48 mx-auto">Loading charter...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen gradient-bg flex items-center justify-center">
        <div className="text-center space-y-4">
          <h1 className="text-2xl font-bold text-gray-800">Charter Not Found</h1>
          <p className="text-gray-600">The charter you're looking for doesn't exist.</p>
      ...
      <Card className="max-w-4xl mx-auto glass-morphism backdrop-blur-xl shadow-2xl border-0">
        <CardContent className="p-4 sm:p-6 lg:p-8">
          <div className="mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Edit Charter</h2>
            <p className="text-gray-600 text-sm sm:text-base">Update your community guidelines and settings</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium text-gray-700">Charter Name</FormLabel>
                    <FormControl>
                      <Input 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium text-gray-700">Select Connected Group</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          ...
                          >
                            {field.value
                              ? groups?.find((group) => group.id === field.value)?.name
                              : "Select a group..."}
                              ...
                              {groups?.map((group) => (
                                ...
                                >
                                  <div className="flex items-center space-x-3 w-full">
                                    <img 
                                      src={group.imageUrl || "https://via.placeholder.com/32"} 
                                      alt={group.name}
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <p className="text-sm text-gray-500 truncate">{group.memberCount} members</p>
                                    </div>
                                    <Check
                                      className={cn(
                                        "mr-2 h-4 w-4",
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium text-gray-700">Charter Description</FormLabel>
                    <FormControl>
                      <WysiwygEditor
                        content={field.value || ""}
              ...
              <div className="space-y-3">
                <Label className="text-sm font-medium text-gray-700">Charter Guidelines</Label>
                <div className="space-y-3">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="border-t pt-6">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Charter Settings</h3>
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4 sm:pt-6">
                ...
                >
                  ...
                  {updateCharterMutation.isPending ? "Updating Charter..." : "Update Charter"}
                </Button>
              </div>
            </form>
          </Form>
