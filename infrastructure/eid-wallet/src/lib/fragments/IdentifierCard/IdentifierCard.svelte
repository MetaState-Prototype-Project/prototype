<script lang="ts">
    ...
    interface IIdentifierCard extends HTMLAttributes<HTMLElement> {eName: string, code: string}
...
<article {...restProps} class={cn(`${cBase}`, restProps.class)}>
    ...
    <div class="grid grid-cols-[65%_35%] items-center gap-2">
        ...
        <ButtonAction callback={handleCopy} class="bg-white text-black">Copy</ButtonAction>
    </div>
