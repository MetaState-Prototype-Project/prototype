    ...
    {#if kycStep === "verifying"}
        ...
        >
            <div class="flex-none flex justify-end px-4 pt-2">
                <button class="text-sm text-black-500 underline" onclick={resetKyc}>
                    Cancel
                </button>
            </div>
    ...
    {#if kycStep === "result"}
        ...
        >
            ...
            {#if diditResult === "approved"}
                ...
                <div class="flex flex-col gap-3 pt-2">
                    <ButtonAction class="w-full" callback={handleUpgrade}>Continue</ButtonAction>
                </div>
            {:else if diditResult === "in_review"}
                ...
                <div class="flex flex-col gap-3 pt-2">
                    <ButtonAction variant="soft" class="w-full" callback={resetKyc}>Close</ButtonAction>
                </div>
            {:else}
                <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-3 pt-2">
                    <ButtonAction class="w-full" callback={startKycUpgrade}>Try Again</ButtonAction>
                    <ButtonAction variant="soft" class="w-full" callback={resetKyc}>Cancel</ButtonAction>
                </div>
            {/if}
        </div>
    {/if}
