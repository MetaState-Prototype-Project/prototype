...
describe('calculateTrustScore', () => {
    ...
    test('KYC user always scores higher than identical non-KYC user', () => {
        const profiles = [
            ...
            { accountAgeDays: 200, keyLocation: 'TPM', thirdDegreeConnections: 50 },
            { accountAgeDays: 365, keyLocation: 'TPM', thirdDegreeConnections: 1000 },
        ];

        for (const profile of profiles) {
            const nonKyc = calculateTrustScore({ ...profile, isVerified: false });
