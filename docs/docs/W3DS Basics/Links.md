...
- **Provisioner**: eVault provisioning (e.g. creating a new eVault for a user).
...
- **Ontology**: Schema registry; list and fetch JSON schemas by UUID. See [Ontology](/docs/Infrastructure/Ontology).
