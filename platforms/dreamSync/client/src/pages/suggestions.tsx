    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Your AI-powered recommendations for connections and groups</p>
        </div>
                  ...
                  <tr>
                    <td colSpan={6} className="px-4 py-8 text-center">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">No suggestions yet</h3>
                          <p className="text-gray-500 text-sm">Complete your profile to get AI-powered suggestions</p>
                        </div>
                        <Button
