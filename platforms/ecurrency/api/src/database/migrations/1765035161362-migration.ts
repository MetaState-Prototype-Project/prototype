...
export class Migration1765035161362 implements MigrationInterface {
    name = 'Migration1765035161362'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ledger_accounttype_enum" AS ENUM('user', 'group')`);
        await queryRunner.query(`CREATE TYPE "public"."ledger_type_enum" AS ENUM('debit', 'credit')`);
        await queryRunner.query(`CREATE TABLE "ledger" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "currencyId" uuid NOT NULL, "accountId" character varying NOT NULL, "accountType" "public"."ledger_accounttype_enum" NOT NULL, "amount" numeric(18,2) NOT NULL, "type" "public"."ledger_type_enum" NOT NULL, "description" character varying, "balance" numeric(18,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7a322e9157e5f42a16750ba2a20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2f972ad154e26f8b4bb6584237" ON "ledger" ("currencyId", "accountId", "accountType") `);
        await queryRunner.query(`CREATE TABLE "currencies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "ename" character varying NOT NULL, "groupId" uuid NOT NULL, "allowNegative" boolean NOT NULL DEFAULT false, "createdBy" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_0dbe684cc54a3dd2cf652272944" UNIQUE ("ename"), CONSTRAINT "PK_d528c54860c4182db13548e08c4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ledger" ADD CONSTRAINT "FK_f5647f02aca88fd9579ff1b6df5" FOREIGN KEY ("currencyId") REFERENCES "currencies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "currencies" ADD CONSTRAINT "FK_5569fd280cb4482a3abc22a1306" FOREIGN KEY ("groupId") REFERENCES "group"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "currencies" ADD CONSTRAINT "FK_4da6e54889b58f6a808d09f55f1" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "currencies" DROP CONSTRAINT "FK_4da6e54889b58f6a808d09f55f1"`);
        await queryRunner.query(`ALTER TABLE "currencies" DROP CONSTRAINT "FK_5569fd280cb4482a3abc22a1306"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2f972ad154e26f8b4bb6584237"`);
        await queryRunner.query(`DROP TABLE "ledger"`);
        await queryRunner.query(`DROP TYPE "public"."ledger_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."ledger_accounttype_enum"`);
