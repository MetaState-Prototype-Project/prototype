...
export default function CharterDetail({
    ...
    return (
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8'>
                        ...
                        <div className='flex space-x-3'>
                            {isEditing ? (
                                ...
                                <>
                                    ...
                                    {currentUser &&
                                        currentUser.id === charter.owner.id && (
                                            <Button
                                ...
                                <div className='flex items-start space-x-4'>
                                    ...
                                    <div className='flex-1'>
                                        ...
                                        <p className='text-red-700 text-sm mb-4'>
                                            Once you delete a charter, there is
                                            no going back. This action cannot be
                                            undone.
                                        </p>
                                        <Button
                                            variant='destructive'
            ...
            {/* Sign Charter Modal */}
            <Dialog
                open={showSignCharterModal}
                onOpenChange={setShowSignCharterModal}
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Sign the Charter</DialogTitle>
                        <DialogDescription>
                            By signing this charter, you agree to abide by all
                            the community guidelines and principles outlined in
                            this document. Your commitment helps maintain a
                            positive and respectful environment for everyone.
                        </DialogDescription>
                    </DialogHeader>
                    <div className='py-4'>
                        <p className='text-sm text-gray-700 mb-2'>
                            Please confirm your understanding and agreement by
