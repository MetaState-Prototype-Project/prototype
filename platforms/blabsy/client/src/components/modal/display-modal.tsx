        ...
        <div className='flex flex-col items-center gap-6'>
            <div className='flex flex-col gap-3 text-center'>
                ...
                <p className='text-light-secondary dark:text-dark-secondary'>
                    These settings affect all the Blabsy accounts on this
                    browser.
                </p>
            </div>
            <article
                ...
                <div className='grid grid-cols-[auto,1fr] gap-3'>
                    ...
                    <div>
                        ...
                        <p className='whitespace-pre-line break-words'>
                            At the heart of Blabsy are short messages called
                            Blabs — just like this one — which can include
                            photos, videos, links, text, hashtags, and mentions
                            like{' '}
                            <span className='text-main-accent'>@blabsy</span>.
                        </p>
                    </div>
                </div>
            </article>
