...
const allNoStatsData: Readonly<NoStatsData> = {
    retweets: {
        title: 'Amplify blabs you like',
        imageData: { src: '/assets/no-reblabs.png', alt: 'No reblabs' },
        description:
            'Share someone else’s Blab on your timeline by Reblabbing it. When you do, it’ll show up here.'
    },
    likes: {
        title: 'No Blab Likes yet',
        imageData: { src: '/assets/no-likes.png', alt: 'No likes' },
        description: 'When you like a Blab, it’ll show up here.'
    },
    following: {
