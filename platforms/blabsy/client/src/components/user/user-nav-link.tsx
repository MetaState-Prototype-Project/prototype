...
export function UserNavLink({ name, path }: UserNavLinkProps): JSX.Element {
    ...
    if (!id || typeof id !== 'string') {
        // If id is missing, render non-clickable nav item
        return (
            <div className='hover-animation main-tab dark-bg-tab flex flex-1 justify-center pointer-events-none'>
                <div className='px-6 md:px-8'>
                    <p className='flex flex-col gap-3 whitespace-nowrap pt-3 font-bold transition-colors duration-200 text-light-secondary dark:text-dark-secondary'>
                        {name}
