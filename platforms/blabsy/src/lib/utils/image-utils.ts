...
export function combineBase64Images(
    images: Array<{ src: string; alt: string; type?: string; id: string }>
): Array<{ src: string; alt: string; type?: string; id: string }> {
 ...
 */
export function combineBase64ImagesAlternative(
    images: Array<{ src: string; alt: string; type?: string; id: string }>
): Array<{ src: string; alt: string; type?: string; id: string }> {
    if (!images || images.length === 0) {
        return images;
