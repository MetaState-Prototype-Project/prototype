...
export class GroupService {
    ...
    async createGroup(
        ...
        // For eSigner Chat groups, use a transaction to prevent race conditions
        if (isPrivate && (name.startsWith("eSigner Chat") || name.includes("eSigner Chat")) && memberIds.length === 2) {
