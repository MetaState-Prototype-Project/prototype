...
type LayoutRouteId = RouteId | "/(protected)/settings" | "/(protected)/settings/account" | "/(protected)/settings/account/deactivate" | "/(protected)/settings/account/username" | "/(protected)/settings/data-and-storage" | "/(protected)/settings/logout" | "/(protected)/settings/notifications"
